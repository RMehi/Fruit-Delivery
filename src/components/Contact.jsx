        ...
        <div class="container px-5 py-4 mx-auto ">
          <div class="flex flex-col text-center w-full mb-12">
            ...
            <p class="lg:w-2/3 mx-auto leading-relaxed text-base">
              Hər hansı bir sualınız yarandıqda bizimlə əlaqə saxlamaqdan
              çəkinməyin.
            </p>
          </div>
          <div class="lg:w-1/2 md:w-2/3 mx-auto">
            <div class="flex flex-wrap -m-2">
              ...
              <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a
                  href="mailto:mahammad.rustamov.2001@gmail.com"
                  class="text-yellow-500"
                >
                  mahammad.rustamov.2001@gmail.com
                </a>
                ...
                <span class="inline-flex">
                  <a
                    href="https://www.facebook.com/mehemmed.rustemov.792740"
                    class="text-gray-500"
                  >
                    <svg
                      fill="currentColor"
                  ...
                  <a href="twitter.com" class="ml-4 text-gray-500">
                    <svg
                      fill="currentColor"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                  ...
                  <a
                    href="https://www.instagram.com/mxxrstm/"
                  ...
                  <a href="tel:0556878106" class="ml-4 text-gray-500">
                    <svg
                      fill="currentColor"
                      stroke-linecap="round"
                      stroke-linejoin="round"
